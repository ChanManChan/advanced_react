const vacationsData = [
  ...
  },
  {
    ...
    price: 2863,
    image:
      'https://cdn-prod.medicalnewstoday.com/content/images/hero/325/325466/325466_1100.jpg',
  ...
  },
  {
    ...
    price: 1605,
    image:
      'https://assets.kpmg/content/dam/kpmg/xx/images/2019/05/white-buildings-near-blue-water-oia-santorini-greece.jpg/jcr:content/renditions/cq5dam.web.512.341.jpg',
...
export const vacations = (req, res, next) =>
  res.send({
    vacations: vacationsData,
    discounts: [vacationsData[0], vacationsData[1]],
  });
